...
tabs = st.tabs(["📈 Markets", "💰 Portfolio", "📊 Correlation", "🗞️ News", "🎓 Learn", "🤖 AI Assistant"])

REFRESH_SEC = st.sidebar.slider("Auto-refresh (seconds)", 30, 120, 60, help="Set how often data refreshes.")
st.sidebar.success("🚀 Project Dashboard — Free Financial Terminal")
...
with tabs[4]:
    ...
    glossary = {
        "P/E Ratio": "Price-to-Earnings ratio — measures company valuation.",
...
with tabs[5]:
    ...
    st.button("🔍 Analyze (demo mode)")

# Auto-refresh hint (Streamlit doesn't auto-refresh natively; user can click 'R' to rerun)
st.caption("Tip: Press **R** to refresh data on demand. Set the sidebar slider to control caching TTL.")
